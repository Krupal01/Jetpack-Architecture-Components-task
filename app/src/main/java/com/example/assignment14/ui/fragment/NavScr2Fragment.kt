...
import com.example.assignment14.databinding.FragmentNavScr2Binding
...
class NavScr2Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireActivity().title = requireContext().getString(R.string.screen2)
        ...
        binding.btnScr2ToScr3.setOnClickListener {
            val navOption = NavOptions.Builder().setPopUpTo(R.id.navScr2Fragment,!viewModel.swScr2ToScr3.value!!).build()
            navController.navigate(R.id.action_navScr2Fragment_to_navScr3Fragment,null,navOption)
        }
    }
